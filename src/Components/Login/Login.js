        ...
        <>
            <div className="bg-neutral-800">
                ...
                <div className="bg-neutral-300 dark:bg-neutral-700 h-screen py-14 px-96 bg-cover bg-no-repeat bg-blend-multiply" style={{backgroundImage:`url(${ImageBackground})`}}>
                    <div className="w-full h-full dark:bg-neutral-800 bg-neutral-200 bg-opacity-80 shadow-inner dark:shadow-white  rounded-2xl">
                        <form action="" className="" id="formLogin">
                            ...
                            <div className="flex flex-col gap-12 pb-10 pt-20 justify-center items-center">
                                <div className="user bg-transparent flex justify-center gap-10">
                                    ...
                                    <input type="email" id="email" className="bg-transparent px-3 font-semibold text-sm dark:text-white text-neutral-700" required autoFocus />
                                </div>
                                <div className="password bg-transparent flex justify-center gap-10">
                                    ...
                                    <input type="password" id="pass" className="bg-transparent px-3 font-semibold text-sm dark:text-white text-neutral-700" required />
                                </div>
                                ...
                                <p className="dark:text-white text-neutral-700">New User? <Link className="dark:hover:text-gray-400 hover:text-gray-950 transition duration-300 text-sm">Sign Up</Link> / <Link href="" className="dark:hover:text-gray-400 hover:text-gray-950 transition duration-300 text-sm">Need Help?</Link></p>
                            </div>
